...
class Project(object):
    ...
    def run_symbolic(self, path, inclusive=False, getHead=False, callee_project=None, state=None, term_on_DC=False, storage_index=None):
        return run_symbolic(self.prg, path, self.code, inclusive=inclusive, state=state, term_on_DC=term_on_DC, storage_index=storage_index)
